...
1. What is the DOM?
A visual Javascript object document that represents the hierarchy of the page and each element as nodes

2. What is an event?
An interaction from the user with the webpage that browsers can listen for

3. What is an event listener?
An attachment on an element that responds to user input and triggers an output

4. Why would we convert a NodeList into an Array?
Array.from()

5. What is a component?
A reusable piece of code that consists of javascript, html and CSS
...
authorName,authorPhoto,headline,id
